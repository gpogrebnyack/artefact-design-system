...
- `subhead/title/headline` — реальные, используемые шаги (`Foundation/TitledRow`, страничные шапки, `AssistantDock`), а не проектные заготовки на будущее.
...
- Токены — в `tokens.ts` (`motion`), не во frontmatter (спека design.md не имеет секции motion — это осознанное расширение в коде + прозе).
